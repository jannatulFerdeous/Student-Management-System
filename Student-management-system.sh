clear
figlet -f digital "Student Management System " -c | lolcat
echo "1.Log In"
echo "2.About"
echo "3.Exit"
teacher() {
...
read password
 ...
 then 
 figlet -f digital "Project By Jannatul Ferdeous " -c | lolcat
 else 
 exit 
 fi
